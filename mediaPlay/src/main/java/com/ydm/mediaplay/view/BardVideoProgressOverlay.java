...
/**
 * Description:滑动快进快退进度框
 * Data：2019/1/30-14:55
 * Author: DerMing_You
 */
public class BardVideoProgressOverlay extends FrameLayout {
    ...
    public BardVideoProgressOverlay(Context context) {
        super(context);
        init();
    }

    public BardVideoProgressOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BardVideoProgressOverlay(Context context, AttributeSet attrs, int defStyleAttr) {

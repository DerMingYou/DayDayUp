...
/**
 * Description:
 * Data：2019/1/30-14:47
 * Author: DerMing_You
 */
public class BardVideoErrorView extends FrameLayout {
    // 正常状态
    ...
    public BardVideoErrorView(Context context) {
        super(context);
        init();
    }

    public BardVideoErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BardVideoErrorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        video_error_retry.setOnClickListener(new View.OnClickListener() {
            @Override

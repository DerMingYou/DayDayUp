...
/**
 * Description: 滑动变化音量|亮度框
 * Data：2019/1/30-14:58
 * Author: DerMing_You
 */
public class BardVideoSystemOverlay extends FrameLayout {
    ...
    public BardVideoSystemOverlay(Context context) {
        super(context);
        initialize(context);
    }

    public BardVideoSystemOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public BardVideoSystemOverlay(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {

...
public class SPUtils {
    ...
    public static SPUtils newInstance(Context context) {
        return newInstance(context, AppConstants.SHARE_PREFERENCES_FILE_NAME);
    }

    public static SPUtils newInstance(Context context, String spName) {
        if (spUtils == null)
     ...
     * @param values 值
     */
    public void putSetString(String key, Set<String> values) {editor.putStringSet(key, values).apply();
    }
